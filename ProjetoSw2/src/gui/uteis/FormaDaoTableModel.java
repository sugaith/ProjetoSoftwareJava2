...
public class FormaDaoTableModel extends AbstractTableModel {

    private static final long serialVersionUID = 1L;
    private List<Forma> lista;
    

    public FormaDaoTableModel() {
        // no construtor, instanciamos o List
        lista = new ArrayList<>();
    }

    public FormaDaoTableModel(List<Forma> lista) {
//        this();
    ...
    public Object getValueAt(int linha, int coluna) {
        ...
        switch (coluna) {
            ...
            case 2:
                return p.getPontos();
            case 3:
                return Uteis.date2TS( p.getCreate_date() );
            default:
                return null;
        }
    }
